...
robot = MoveGroupPythonInterface("motoman_gp4")
joint_list, cartesian_position, cartesian_orientation = robot.get_position()

print("Angulos: ", joint_list)
print("Posicion (x,y,z): ", cartesian_position)
print("Orientacion (r,p,y): ", cartesian_orientation)

robot.go_to_home()

robot.scale_ROT = 1.5708
robot.joints_move("j1", "forward")

robot.scale_ROT = 1.5708
robot.joints_move("j2", "forward")

robot.scale_ROT = 1.5708
robot.joints_move("j3", "forward")

robot.scale_ROT = 3.14
robot.joints_move("j1", "reverse")
